...
import { TagChip, getTagColor } from './TagSelector';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        {yearsLoading ? (
          ...
          <>
            ...
            {/* ── Search + Filter Bar ── */}
            <div className="sticky top-[125px] z-30 bg-background py-2 -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 border-b border-border space-y-2">

              {/* Row 1: filter dropdown + search + clear */}
              <div className="flex items-center gap-2">
                <DropdownMenu>
